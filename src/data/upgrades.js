export const UPGRADES = [
  ...
  { id: 'u5', name: 'Marketing Campaign', category: 'marketing', description: 'More customers arrive', level: 0, costs: [500, 1000, 2000, 4000], effects: { type: 'customerRate', value: 0.0001 } },
