...
export function getServiceCounterItemPosition(counter, slot) {
  ...
  const dx = COUNTER_COLUMN_X[slot % 4] - 60;
  const dy = COUNTER_ROW_Y[Math.floor(slot / 4)] - 20;
